...
Crie um array numérica embaralhado com diversificação de números (200, 15, 10)… 
com no mínimo 20 números e no máximo 100 (não repetidos).

Ordene esse array do menor para o maior número, exiba na tela o array antigo e o array novo ordenado.

Obs: O array deverá ser criado por você (não fazer o usuário digitar).
